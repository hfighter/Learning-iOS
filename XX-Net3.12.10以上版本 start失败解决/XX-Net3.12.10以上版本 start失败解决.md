针对XX-Net3.12.10以上版本 start失败，提示Run XX-Net in background.  主要原因是XX-Net基于Python2.7运行，如果本地安装了Ptyhon3，导致运行失败。解决方法：用一下内容替换start文件中的内容(https://github.com/XX-net/XX-Net/raw/mac-patch/start)
